      ...
      for (i=0; i<numberOfVariables; i++){
        ...
        if (PseudoRandom.randDouble()<=0.5 ){
          if (java.lang.Math.abs(valueX1- valueX2) > EPS){
            ...
            if (PseudoRandom.randDouble()<=0.5) {
              offs1.setValue(i, Math.floor(c2)) ;
              offs2.setValue(i, Math.floor(c1)) ;
            } else {
              offs1.setValue(i, Math.floor(c1)) ;
              offs2.setValue(i, Math.floor(c2)) ;
            } // if
          } else {
            offs1.setValue(i,Math.floor(valueX1)) ;
            offs2.setValue(i, Math.floor(valueX2)) ;
          } // if
        } else {
          offs1.setValue(i, Math.floor(valueX2)) ;
          offs2.setValue(i, Math.floor(valueX1)) ;
        } // if
      } // if
    } // if

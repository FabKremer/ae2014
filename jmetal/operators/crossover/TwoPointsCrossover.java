...
//			else if (parent1.getType().getClass() == ArrayRealSolutionType.class) {
//				if (PseudoRandom.randDouble() < probability) {
//					int crosspoint1        ;
//					int crosspoint2        ;
//					int decisionVariablesLength  ;
//					Variable parent1Vector[]    ;
//					Variable parent2Vector[]    ;
//					Variable offspring1Vector[] ;
//					Variable offspring2Vector[] ;
//	
//					decisionVariablesLength = parent1.getDecisionVariables().length;
//					parent1Vector    = parent1.getDecisionVariables() ;
//					parent2Vector    = parent2.getDecisionVariables() ;    
//					offspring1Vector = ((ArrayReal)offspring[0].getDecisionVariables()[0]).array_ ;
//					offspring2Vector = ((ArrayReal)offspring[1].getDecisionVariables()[0]).array_ ;
//	
//					// STEP 1: Get two cutting points
//					crosspoint1 = PseudoRandom.randInt(0,decisionVariablesLength-1) ;
//					crosspoint2 = PseudoRandom.randInt(0,decisionVariablesLength-1) ;
//	
//					while (crosspoint2 == crosspoint1)  
//						crosspoint2 = PseudoRandom.randInt(0,decisionVariablesLength-1) ;
//	
